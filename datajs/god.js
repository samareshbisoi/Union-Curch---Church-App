		...
		$.getJSON(url,function(result){ //alert(result);
	        ...
	        $.each(result, function(i, field){
				...
				img_value = ImgURL+dir+"/"+god_image;
	             $("#listview").append("<li class='swipeout'><div class='swipeout-content item-content'><div class='post_entry'><div class='post_thumb'><img src='"+img_value+"' width='200' alt='' title='' /></div><div class='post_details'><div class='post_category'><a href='god-details.html?"+ god_id + "'>"+ god_title + "</a></div><span style='font-size:12px;'>  </span></div></div></div></li>");
				/*}*/
	        });
    	});	
		}
	...
	$(document).ready(function()
		...
		$.getJSON(url,function(result){ //alert(result);
	        ...
	        $.each(result, function(i, field){
				...
				/* $("#listview").append("<li class='swipeout'><div class='swipeout-content item-content'><div class='post_entry'><div class='post_thumb'><img src='"+img_value+"' width='200' alt='' title='' /></div><div class='post_details'><div class='post_category'><a href='article-details.html?"+ testi_id + "'>"+ god_title + "</a></div><h2><a href='article-details.html?"+ testi_id + "'>"+ article_body +"</a></h2>By Fresh Box Office on "+post_date+"</div><div class='post_swipe'><img src='images/swipe_more.png' alt='' title='' /></div></div></div></li>");*/
				//}
	        });
    	});
